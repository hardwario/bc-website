...
2. Insert the following snippet in the flow (using **Menu >> Import**) and click in **Flow 1** tab:
    ...
    ```json
    [{"id":"147f6d1c.518cb3","type":"inject","z":"94b4c892.b487b8","name":"led true","topic":"node/{id}/led/-/state/set","payload":"true","payloadType":"bool","repeat":"","crontab":"","once":false,"onceDelay":"","x":190,"y":60,"wires":[["442fa480.91c01c"]]},{"id":"74bf5634.5aad58","type":"inject","z":"94b4c892.b487b8","name":"led false","topic":"node/{id}/led/-/state/set","payload":"false","payloadType":"bool","repeat":"","crontab":"","once":false,"onceDelay":"","x":200,"y":100,"wires":[["442fa480.91c01c"]]},{"id":"e2f5e6d0.97be68","type":"inject","z":"94b4c892.b487b8","name":"relay true","topic":"node/{id}/relay/-/state/set","payload":"true","payloadType":"bool","repeat":"","crontab":"","once":false,"onceDelay":"","x":200,"y":200,"wires":[["442fa480.91c01c"]]},{"id":"27a1530.0421cae","type":"inject","z":"94b4c892.b487b8","name":"relay false","topic":"node/{id}/relay/-/state/set","payload":"false","payloadType":"bool","repeat":"","crontab":"","once":false,"onceDelay":"","x":200,"y":240,"wires":[["442fa480.91c01c"]]},{"id":"37a4d1b3.774d6e","type":"inject","z":"94b4c892.b487b8","name":"led get","topic":"node/{id}/led/-/state/get","payload":"null","payloadType":"json","repeat":"","crontab":"","once":false,"onceDelay":"","x":190,"y":140,"wires":[["442fa480.91c01c"]]},{"id":"c41354e7.2bf238","type":"inject","z":"94b4c892.b487b8","name":"relay get","topic":"node/{id}/relay/-/state/get","payload":"null","payloadType":"json","repeat":"","crontab":"","once":false,"onceDelay":"","x":200,"y":280,"wires":[["442fa480.91c01c"]]},{"id":"216ca6db.cc1bea","type":"inject","z":"94b4c892.b487b8","name":"led-strip set color #ff0000","topic":"node/{id}/led-strip/-/color/set","payload":"\"#ff0000\"","payloadType":"str","repeat":"","crontab":"","once":false,"onceDelay":"","x":250,"y":340,"wires":[["442fa480.91c01c"]]},{"id":"ea530e7c.e76e9","type":"inject","z":"94b4c892.b487b8","name":"led-strip set color #008000","topic":"node/{id}/led-strip/-/color/set","payload":"\"#008000\"","payloadType":"str","repeat":"","crontab":"","once":false,"onceDelay":"","x":250,"y":380,"wires":[["442fa480.91c01c"]]},{"id":"25e2e7b4.cf2598","type":"inject","z":"94b4c892.b487b8","name":"led-strip compound","topic":"node/{id}/led-strip/-/compound/set","payload":"[20, \"#ff0000\", 20, \"#ff7f00\", 20, \"#ffff00\", 20, \"#00ff00\", 20, \"#0000ff\", 20, \"#960082\", 24, \"#D500ff\"]","payloadType":"json","repeat":"","crontab":"","once":false,"onceDelay":"","x":230,"y":580,"wires":[["442fa480.91c01c"]]},{"id":"470dce5a.e3ca5","type":"inject","z":"94b4c892.b487b8","name":"led-strip effect test","topic":"node/{id}/led-strip/-/effect/set","payload":"{\"type\":\"test\"}","payloadType":"json","repeat":"","crontab":"","once":false,"onceDelay":"","x":230,"y":620,"wires":[["442fa480.91c01c"]]},{"id":"85490d3c.a79e8","type":"inject","z":"94b4c892.b487b8","name":"led-strip effect rainbow","topic":"node/{id}/led-strip/-/effect/set","payload":"{\"type\":\"rainbow\", \"wait\":50}","payloadType":"json","repeat":"","crontab":"","once":false,"onceDelay":"","x":240,"y":660,"wires":[["442fa480.91c01c"]]},{"id":"d9f04ae9.979cf8","type":"inject","z":"94b4c892.b487b8","name":"led-strip effect rainbow-cycle","topic":"node/{id}/led-strip/-/effect/set","payload":"{\"type\":\"rainbow-cycle\", \"wait\":50}","payloadType":"json","repeat":"","crontab":"","once":false,"onceDelay":"","x":260,"y":700,"wires":[["442fa480.91c01c"]]},{"id":"6517d5a3.72d48c","type":"inject","z":"94b4c892.b487b8","name":"led-strip effect theater-chase-rainbow","topic":"node/{id}/led-strip/-/effect/set","payload":"{\"type\":\"theater-chase-rainbow\", \"wait\":50}","payloadType":"json","repeat":"","crontab":"","once":false,"onceDelay":"","x":290,"y":740,"wires":[["442fa480.91c01c"]]},{"id":"4c240d8d.d05fb4","type":"inject","z":"94b4c892.b487b8","name":"led-strip set brightness 50%","topic":"node/{id}/led-strip/-/brightness/set","payload":"50","payloadType":"str","repeat":"","crontab":"","once":false,"onceDelay":"","x":260,"y":480,"wires":[["442fa480.91c01c"]]},{"id":"cf0891d9.784af","type":"inject","z":"94b4c892.b487b8","name":"led-strip set brightness 100%","topic":"node/{id}/led-strip/-/brightness/set","payload":"100","payloadType":"str","repeat":"","crontab":"","once":false,"onceDelay":"","x":260,"y":520,"wires":[["442fa480.91c01c"]]},{"id":"c460c47d.4727a8","type":"inject","z":"94b4c892.b487b8","name":"led-strip effect color-wipe blue","topic":"node/{id}/led-strip/-/effect/set","payload":"{\"type\":\"color-wipe\", \"wait\":50, \"color\": \"#0000ff\"}","payloadType":"json","repeat":"","crontab":"","once":false,"onceDelay":"","x":260,"y":780,"wires":[["442fa480.91c01c"]]},{"id":"84278ee0.9314d","type":"inject","z":"94b4c892.b487b8","name":"led-strip set color #000000(00)","topic":"node/{id}/led-strip/-/color/set","payload":"\"#000000(00)\"","payloadType":"str","repeat":"","crontab":"","once":false,"onceDelay":"","x":260,"y":420,"wires":[["442fa480.91c01c"]]},{"id":"75e4394.5e9d7c8","type":"mqtt out","z":"94b4c892.b487b8","name":"","topic":"","qos":"","retain":"","broker":"37f1af88.431e4","x":930,"y":420,"wires":[]},{"id":"442fa480.91c01c","type":"change","z":"94b4c892.b487b8","name":"set node id","rules":[{"t":"change","p":"topic","pt":"msg","from":"{id}","fromt":"str","to":"kit-power-controller:0","tot":"str"}],"action":"","property":"","from":"","to":"","reg":false,"x":750,"y":420,"wires":[["75e4394.5e9d7c8"]]},{"id":"37f1af88.431e4","type":"mqtt-broker","z":"","broker":"localhost","port":"1883","clientid":"","usetls":false,"compatmode":true,"keepalive":"60","cleansession":true,"birthTopic":"","birthQos":"0","birthPayload":"","willTopic":"","willQos":"0","willPayload":""}]
    ```
