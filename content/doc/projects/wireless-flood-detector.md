...
10. Edit the **Notification** field and insert the text `The flood detector has been flooded on {{OccurredAt}}` and push the **Create action** button:
...
15. Insert the name `flood` in the **event** field and keep the window open:
