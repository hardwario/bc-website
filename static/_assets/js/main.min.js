...
$(function () {
    ...
    $('.switch>div').click(function(){        
        ...
        $(this).parent().find('input[type=hidden]').val($(this).data('val'));
    });
    ...
    $('.addbutton2').on('click',function(){
       var div = $(this).parent().parent().clone(true);
       div.appendTo($(this).parent().parent().parent());
       $(this).hide();
       $(this).parent().parent().parent().find('.delete').show();
       div.find('input').val('').attr('checked',false);       
       div.find('.switch input').val('');
       div.find('.switch>div').removeClass('active');
       
       var cnt = $(this).parent().parent().prevAll().length+2;
       div.find('h3 span').text(cnt);
    });
    ...
    $('.addbutton4').on('click',function(){
        ...
        if($('.copy3 h3').length==1)
        {
            $('.copy3 .addbutton4').hide();
            $('.copy3 .addbutton2,.copy3 .addbutton3').show();
        }
        
        var i=1;
        $('.copy3 h3').each(function(){
    ...
    $('#addbutton1').click(function(){
       var div = $('.copy1').find('.calendar').eq(0).clone();
       div.appendTo('.copy1').find('input').val("");
       var div = $('.copy2').find('.calendar').eq(0).clone();
       div.appendTo('.copy2').find('input').val("");
       
       $('.copy2').addClass('copy2--more');   
       ...
       div.find('.delete').click(function(){
            ...
            {        
                ...
                $('.copy1 .calendar').eq(i).remove();
                $('.copy2 .calendar').eq(i).remove();

                if($('.copy1 .calendar').length==1)
                {
                    $('.copy2').removeClass('copy2--more');
                }                
            }            
        });
    });        
