...
* Find more about dfu mode [here]({{< relref "doc/old/core-module-flashing.md#flashing-firmware-thru-usb-dfu-bootloader" >}})

* if you will use your own PC, then follow these instructions [here]({{< relref "doc/old/core-module-flashing.md" >}}) you will find a firmware here [https://github.com/bigclownlabs/bcp-climate-station/releases/latest](https://github.com/bigclownlabs/bcp-climate-station/releases/latest), LED Thermometer has 72 diodes, so download firmware-72pixel.bin
