...
1. Open **Node-RED** in your web browser:
    ...
    **http://localhost:1880/**
    ...
    {{< note "info" "If you are using Raspberry PI with USB Dongle as a gateway type IP adress of your Raspberry. To obtain IP adress follow documment [**Raspberry Pi Login**]({{< relref "doc/tutorials/raspberry-pi-login.md" >}})." />}}
