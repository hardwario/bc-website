...
1. Starter Kit \[put together and pair]({{< ref "/handbook/_index.cs.md" >}}). If you don’t know how to download the firmware or what it is, \[you will find out here]({{< ref "/academy/how-to-flash-firmware.cs.md" >}}).
